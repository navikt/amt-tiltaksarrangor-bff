package no.nav.tiltaksarrangor.endringsmelding.api.request
...
fun EndringsmeldingRequest.toEndringsmeldingDbo(endringsmeldingId: UUID, deltakerId: UUID): EndringsmeldingDbo = EndringsmeldingDbo(
...
fun EndringsmeldingRequest.Innhold.toEndringsmeldingInnhold(): Innhold = when (this) {
