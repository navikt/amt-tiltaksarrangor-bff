...
class VeilederControllerTest : IntegrationTest() {
	...
	fun `getMineDeltakere - autentisert - returnerer 200`() {
		...
		val expectedJson = """
			[{"id":"977350f2-d6a5-49bb-a3a0-773f25f863d9","deltakerliste":{"id":"9987432c-e336-4b3b-b73e-b7c781a0823a","navn":"Gjennomføring 1"},"fornavn":"Fornavn","mellomnavn":null,"etternavn":"Etternavn","fodselsnummer":"10987654321","status":{"type":"DELTAR","endretDato":"2023-02-01T00:00:00"},"startDato":"2023-02-15","sluttDato":null,"veiledertype":"VEILEDER","aktiveEndringsmeldinger":[]}]
		""".trimIndent()
