...
class TiltaksarrangorControllerTest : IntegrationTest() {
	...
	private fun getEndringsmeldinger(deltakerId: UUID): List<EndringsmeldingDbo> {
		return listOf(
			EndringsmeldingDbo(
