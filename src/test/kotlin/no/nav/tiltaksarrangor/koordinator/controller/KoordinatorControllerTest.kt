...
class KoordinatorControllerTest : IntegrationTest() {
	...
	fun `getDeltakerliste - autentisert - returnerer 200`() {
		...
		val expectedJson =
			"""
			{"id":"9987432c-e336-4b3b-b73e-b7c781a0823a","navn":"Gjennomføring 1","tiltaksnavn":"Navn på tiltak","arrangorNavn":"Arrangør AS","startDato":"2023-02-01","sluttDato":null,"status":"GJENNOMFORES","koordinatorer":[{"fornavn":"Fornavn1","mellomnavn":null,"etternavn":"Etternavn1"},{"fornavn":"Fornavn2","mellomnavn":null,"etternavn":"Etternavn2"}],"deltakere":[{"id":"252428ac-37a6-4341-bb17-5bad412c9409","fornavn":"Fornavn","mellomnavn":null,"etternavn":"Etternavn","fodselsnummer":"10987654321","soktInnDato":"2023-01-15T00:00:00","startDato":"2023-02-01","sluttDato":null,"status":{"type":"DELTAR","endretDato":"2023-02-01T00:00:00","aarsak":null},"veiledere":[],"navKontor":"NAV Testheim","aktiveEndringsmeldinger":[],"gjeldendeVurderingFraArrangor":null,"adressebeskyttet":false,"erVeilederForDeltaker":false,"aktivEndring":null,"forsteVedtakFattetDato":"2023-01-15"}],"erKurs":false,"tiltakType":"ARBFORB"}
			""".trimIndent()
		response.code shouldBe 200
		response.body?.string() shouldBe expectedJson
	}
